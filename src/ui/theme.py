...
COVER_RADIUS = 10
COVER_BORDER = 3
COVER_FRAME = COVER_BORDER + 1
COVER_OUTER_WIDTH = COVER_WIDTH + COVER_FRAME * 2
COVER_OUTER_HEIGHT = COVER_HEIGHT + COVER_FRAME * 2
EMU_COVER_SIZE = 152
EMU_COVER_OUTER = EMU_COVER_SIZE + COVER_FRAME * 2
BTN_WIDTH = 128
BTN_HEIGHT = 36
